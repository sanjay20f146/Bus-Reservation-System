...
public class BookingDetails {
    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("sanjay") && password.equals("1542")){
    		...
    		for(int x=1; x==1;){
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("***************************************");
						System.out.println("** 1.)CHENNAI        | Php600 |   "+available[1]+"   **");
    					System.out.println("** 2.)THRICHY        | Php170 |   "+available[2]+"   **");
    					System.out.println("** 3.)MADURAI        | Php150 |   "+available[3]+"   **");
    					System.out.println("** 4.)DINDUGAL       | Php200 |   "+available[4]+"   **");
    					System.out.println("** 5.)THENI          | Php250 |   "+available[5]+"   **");
    					System.out.println("***************************************");
						System.out.println("***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "CHENNAI", "THRICHY", "MADURAI", "DINDUGAL", "THENI"};
